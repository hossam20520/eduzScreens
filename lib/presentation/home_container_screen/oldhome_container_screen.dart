      ...
      body: Stack(children: [
        ...
        Transform(
          ...
          transform: Matrix4.identity()
            ..setEntry(3, 2, 0.001)
            ..rotateY(10 * pi / 180), //0 to 10
          child: Transform.translate(
            offset: Offset(300, 0), // 0 to 300
        ...
        AnimatedPositioned(
          ...
          curve: Curves.fastOutSlowIn,
          // left: controller.isSideMenuClosed ? 0 : 220,
          top: 16,
          child: MenuBtn(
            riveOnInit: (artboard) {
              ...
              // controller.isSideBarClosed =
                  Localcontroller.findSMI("isOpen") as SMIBool;
              // Now it's easy to understand
              // controller.isSideBarClosed.value = true;
            },
            // Let's fixed the scal animation
            press: () {
              // controller.isSideBarClosed.value =
                  // !controller.isSideBarClosed.value;
              // if (controller.isSideMenuClosed) {
              //   controller.animationController.forward();
              // } else {
              //   controller.animationController.reverse();
              // }
              // controller.isSideMenuClosed = controller.isSideBarClosed.value;
            },
          ),
        ),
      ]),
